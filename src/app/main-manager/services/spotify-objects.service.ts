...
export class SpotifyObjectsService {
  ...
  constructor() { 
    ...
    DARK_PASSION_PLAY.tracks = [AMARANTH_2, EVA];
    AMARANTH_SINGLE.tracks = [AMARANTH_EDIT, AMARANTH_EDIT2, AMARANTH_EDIT3, AMARANTH_REMASTER, AMARANTH_REMASTER2];
    ENDLESS_FORMS.tracks = [ELAN, ALPENGLOW];
    ENDLESS_FORMS_DELUXE.tracks = [ELAN_DELUXE, ALPENGLOW_DELUXE];
